...
if (isset($_POST["signup"])) {
  ...
  if ($password !== $cpassword) {
    ...
    if ($result) {
      ...
      echo "<script>alert('We have sent a verification link to your email - {$base_url}verify-email.php?token={$token}');</script>";
    }else {
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <p>
            Not a member yet? <br>Click on the Sign Up button below to be a part of PARK-INN
          </p>
      ...
      <div class="panel right-panel">
        <div class="content">
          <h3>SMART PARKING SYSTEM</h3>
          <p>
            Already a member? <br>Click on the Sign In button to login and book a parking spot with PARK-INN
          </p>
